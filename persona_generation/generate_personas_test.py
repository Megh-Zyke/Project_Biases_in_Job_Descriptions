...
DEFAULT_MODEL = os.getenv("MODEL", "microsoft/phi-2")  # Example: "microsoft/phi-2", "gemma-7b", etc.
...
# Better prompt for Qwen instruction models
PROMPT_TEMPLATE = (
    "<|im_start|>system\n{system_instruction}<|im_end|>\n"
    "<|im_start|>user\n"
    "Job description:\n{description}\n\n"
    "Generate a JSON persona with these exact fields: title, summary, age_range, education, "
    "experience_years, core_skills, personality_traits, top_responsibilities, "
    "salary_estimate_usd, hireability_score, short_pitch.\n"
